...
export RESEACT_LABEL="${RESEACT_LABEL:-nondet1t}"
...
export RESEACT_JOBDIR="${RESEACT_JOBDIR:-/tmp/claude-1111265/wt-nanhunt/tools/diag/jobs1t}"
...
cd "$(dirname "$0")/../.."
exec taskset -c "${NANHUNT_CPU:-8}" julia tools/diag/nondet_server.jl
